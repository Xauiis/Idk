...
export const SKILLS: SkillDef[] = [
  ...
  { id: 'transmutation', name: 'Transmutation', cluster: 'product', icon: '⚒️', color: '#d6a85a', blurb: 'Forge salts and essences into materials, tools and treasures.' },
  { id: 'inscription', name: 'Inscription', cluster: 'process', icon: '🪶', color: '#b08fd0', blurb: 'Etch sigils — and program your lines to brew just enough.' },
  { id: 'remedycraft', name: 'Remedycraft', cluster: 'product', icon: '🧪', color: '#d9663f', blurb: 'Formulate essences into finished remedies.' },
  { id: 'feltcraft', name: 'Feltcraft', cluster: 'product', icon: '🫧', color: '#d68fc4', blurb: 'Distill and bottle emotions for the townsfolk who need them.' },
